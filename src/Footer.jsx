        ...
        <footer className="footer footer-center p-10 bg-primary text-primary-content mt-5">
            <aside>
                ...
                <p className="font-bold">
                    Job the Chakri <br />Providing reliable Job since 2015
                </p>
                <p>Copyright © 2023 - All right reserved</p>
                <div className="flex gap-4">
                    <div className="flex justify-center items-center gap-1"><AiOutlinePhone className="text-lg"/>012487951132 </div>
                    <div className="flex justify-center items-center gap-1">
                    <AiOutlineMail/>saadhuzaifa@gmail.com
                    </div>
                </div>
                <p className="flex gap-1 justify-center items-center"><HiBuildingOffice /> Mirabag,Jarabati,Dhaka-4012</p>
            </aside>
            <nav>
